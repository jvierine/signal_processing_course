...
\end{equation}
At the discontinuity the series converges to the midpoint of the jump. Adding more harmonics makes the oscillating region narrower, but the overshoot approaches $8.95\%$ of the jump. This is the \emph{Gibbs phenomenon}: convergence is pointwise but not uniform, and analogous ringing occurs near sharp transitions in time or frequency.

The phenomenon was first analyzed by Wilbraham in 1848 and later brought to wider attention by Gibbs in two \emph{Nature} letters prompted by Michelson's harmonic-analyzer observations \cite{wilbraham1848periodic,michelson1898fourier,gibbs1898fourier,gibbs1899fourier}.
