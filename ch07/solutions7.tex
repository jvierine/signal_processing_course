...
\lstinputlisting[language=Python,caption=Suggested solution to a),label=code:7.3a]{ch07/code/ex7_3a}
...
\lstinputlisting[language=Python,caption=Suggested solution to b),label=code:7.3b]{ch07/code/ex7_3b}
...
\lstinputlisting[language=Python,caption=Suggested solution to c),label=code:7.3c]{ch07/code/ex7_3c}
