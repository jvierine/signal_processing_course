...
\emph{\index{Matplotlib}{Matplotlib}} libraries. If you are already
...
\begin{enumerate}
  ...
  % Exercise 4
  \item The use of built-in NumPy \emph{\index{array functions}{array functions}} will let you program
        efficiently. The program shown in Listing \ref{lst:exercise002}
        demonstrates the use of NumPy functions to evaluate the \index{Mandelbrot set}{Mandelbrot set} with a slight twist.
