...
The \index{Anaconda}{Anaconda} package manager will allow you to install \index{NumPy}{NumPy}, \index{SciPy}{SciPy},
and \index{Matplotlib}{Matplotlib}. Anaconda also comes with a Python development
...
environment that comes with Anaconda. Another popular development environment is Microsoft's \index{Visual Studio Code}{Visual Studio Code}.
...
manager. On \index{Ubuntu}{Ubuntu}, you would install the necessary packages with the following command:
