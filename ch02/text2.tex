...
All of the programming examples we'll show in these lecture notes will
...
\lstinputlisting[language=Python,caption={\texttt{001\_hello\_world/hello.py}},label=lst:pythonhw]{ch02/code/hello.py}
