...
\lstinputlisting[language=Python,caption={Solution for Exercise 4.7},label=ex4.8]{ch04/code/ex8.py}
...
\lstinputlisting[language=Python,caption={Solution for Exercise 4.8},label=ex4.9]{ch04/code/ex9.py}
