...
\lstinputlisting[language=Python,caption={Solution for Exercise 4.7},label=ex4.7]{ch04/code/ex4.7.py}
...
\lstinputlisting[language=Python,caption={Solution for Exercise 4.8},label=ex4.8]{ch04/code/ex4.8.py}
