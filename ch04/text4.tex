...
This type of signal is called a \emph{\index{quantized}{quantized}} signal. 
...
\newthought{An example of a case that is not time-invariant} is $y(t) = \mathcal{T}\{x(t)\} = t + x(t)$. 
