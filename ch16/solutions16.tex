...
\lstinputlisting[language=Python, caption=Code to plot audio signal,label=code16_4,linerange={0-19}]{ch16/code/ex16_1b.py}
...
\lstinputlisting[language=Python, caption=Spectogram code, label=code16_5,linerange={0-64}]{ch16/code/ex16_1c.py}
