...
\end{lstlisting}
        ...
        \begin{enumerate}[a)]
          ...
          \item The following code will import the audio file and plot the signal with seconds on the $x$-axis.
                \lstinputlisting[language=Python, caption=Code to plot audio signal, label=code16_4, linerange={0-20}]{ch16/code/ex16_1b.py}
          ...
          \item The following code shown in Listing \ref{code16_5} will compute and print the spectrogram for the audio signal.
                ...
                \lstinputlisting[language=Python, caption=Spectrogram code, label=code16_5, linerange={0-69}]{ch16/code/ex16_1c.py}
