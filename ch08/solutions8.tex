  ...
  \item
        \begin{enumerate}[a)]
          ...
          \item If $\hat{x}(\omega)=\cos^{2}(\omega)$, then we find $x(t)$ by using the inverse Fourier transform:
                ...
                \[ x(t)=\frac{1}{2\pi}\int_{-\infty}^{\infty}\frac{1}{4}\left(e^{2i\omega }+e^{-2i\omega}+2\right)e^{i\omega t}d\omega=\underline{\underline{\frac{1}{4}\delta(t+2)+2\delta(t)+\frac{1}{4}\delta(t-2)}}. \]
        \end{enumerate}
