...
Spectral methods are also central to the analysis of differential equations,
where they can turn differentiation into algebraic multiplication. Similar
frequency-selective spatial filters have been found in the mammalian visual
cortex.

These neural responses select localized patterns with particular
