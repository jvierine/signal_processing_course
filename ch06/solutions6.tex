...
\lstinputlisting[language=Python,caption={Noise canceling signal},label=cancel]{ch06/code/ex6.1.py}
...
\lstinputlisting[language=Python,caption={Adding frequencies},label=sig42]{ch06/code/ex6.6.py}
...
\lstinputlisting[language=Python,caption={Modifying signals},label=sig42_mod]{ch06/code/ex6.7a.py}
