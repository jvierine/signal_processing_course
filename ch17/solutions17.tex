...
\lstinputlisting[language=Python, caption=Spectrum for noisy signal in Figure \ref{fig17_1},label=code17_2,linerange={0-37}]{ch17/code/ex17_1a.py}
...
\lstinputlisting[language=Python, caption=Filtering of the signal,label=code17_3,linerange={0-57}]{ch17/code/ex17_1b.py}
