...
\lstinputlisting[language=Python, caption=Example signal code,label=code17_1]{ch17/code/ex17_1.py}
...
\lstinputlisting[language=Python, caption=Spectrum for noisy signal in Figure \ref{fig17_1},label=code17_2]{ch17/code/ex17_1a.py}
...
\lstinputlisting[language=Python, caption=Filtering of the signal,label=code17_3]{ch17/code/ex17_1b.py}
