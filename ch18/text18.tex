...
% ================= NOT USED =================
\if 0
  The numerator of the system function is a second order polynomial. The \emph{fundamental theorem of algebra}
...
the polynomial into a form with positive exponents: $\Hez =
  ...
  - 1=0$ using a symbolic calculator such as Wolfram Alpha.
You don't need to make it a priority to learn how to solve higher order polynomials using pencil and paper.
We have computers for that.} Figure \ref{fig:pole_zero_third_order} shows the
...
The zeros of the system function, that lie on the unit circle $z=e^{i\hat{\omega}}$, correspond to the frequencies at which
...
\begin{marginfigure}
  ...
  Below: The phase angle of the system function corresponding to a running average filter.}
  \label{fig:rma_l20}
\end{marginfigure}
