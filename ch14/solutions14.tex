  ...
  \item The Hann window in continuous-time is defined as:
        ...
        \begin{enumerate}[a)]
          ...
          \item To plot the spectral responses, we can use Listing \ref{code14_1}.
                \lstinputlisting[language=Python, caption=Filter spectral response, label=code14_1, linerange={0-30}]{ch14/code/ex14_1.py}
          ...
          \item The wave functions $\Psi(x)$ and $\hat{\Psi}(k)$ are shown in Figure \ref{x:wavefunction} 
                ...
                \begin{marginfigure}
                  \begin{tikzpicture}
                    ...
                    \end{axis}
                  \end{tikzpicture}
                  \caption{The wave function $\hat{\Psi}(k)$ in wavenumber space, with $\Delta k=\frac{\pi}{T}$.}
