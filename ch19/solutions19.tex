...
\begin{marginfigure}
    ...
    \end{tikzpicture}
    \end{center}
    \caption{The system function has one zeros and one pole in this case. There is a zero at $z=0$ and a pole at $z=0.8$. Zero displayed as a blue circle
    and pole as a red cross.}
    \label{iir:ex3}
    \end{marginfigure}
...
\item Diagram b) and c) both reduce high frequency components and keeps low frequency components, 
...
function corresponds to a stable BIBO LTI system if all the poles lie inside the unit circle. 
